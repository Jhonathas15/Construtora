  ...
  return (
    <div className="h-full p-2">
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-xl border-2 border-black w-full  md:w-full lg:w-3/4 xl:w-2/3 2xl:1/2">
          <table className="w-full text-center">
            <thead className="bg-gray-300 border-b-2 border-black">
              <tr className="">
                <td className="border-r-2 border-black p-2 md:p-3">Documento</td>

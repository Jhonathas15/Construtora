  ...
  return (
      ...
      <div className="h-full w-full p-2">
        ...
        <form className="flex flex-col m-10" method="post">
            ...
            <input className="border-2 border-black w-full md:w-3/4 lg:w-1/2 2xl:w-1/2 rounded-2xl p-3 mb-3" type="password" />

            <h2 className="text-xl mb-2">Nova senha</h2>
            <input className="border-2 border-black w-full md:w-3/4 lg:w-1/2 2xl:w-1/2 rounded-2xl p-3 mb-4" type="password" />

            <h2 className="text-xl mb-2">Repetir nova senha</h2>
            <input className="border-2 border-black w-full md:w-3/4 lg:w-1/2 2xl:w-1/2 rounded-2xl p-3 mb-5" type="password" />

            <button className="bg-black text-xl font-semibold text-white p-3 rounded-2xl w-full md:w-1/3" type="submit">Enviar</button>
        </form>
      </div>
  );
}
